...
plot, x, etas, title='ETA LEVELS', xtickinterval=tinv, psym=3
;!psym=3 & oplot, x, etas
;!psym=0
plot, x, pseudo, title='ALTITUDE (km)', xtickinterval=tinv, psym=3
;!psym=3 & oplot, x, pseudo 
;!psym=0
plot, x, pi, title='PRESSURE (Pa)', ylog=1, xtickinterval=tinv, psym=3
;!psym=3 & oplot, x, pi 
;!psym=0
;
...
;plot, x, ecart, title='d ALTITUDE (km)', xtickinterval=tinv, psym=1
plot, x, diff, title='d ALTITUDE (km)', xtickinterval=tinv, psym=3
;!psym=3 & oplot, x, diff
;!psym=0
